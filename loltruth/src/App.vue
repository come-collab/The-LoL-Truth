<template>
  <div id="app">
    ...
    <p><strong>Tech Sidenote :</strong> This site comes with a scrapper. The data is taken from multiples sources League of Legend API,
    ...
    <p>The whole point is to help people to have more realistic goals on LoL and help them enjoy the game more without being devoured by the 
      ...
      are at the place they are at and a big part of that is inner skill.
