<template>
    ...
    <p>The purpose of this graph is to understand that for most of the top players it didn't took a lot of time to reach
        ...
        in two years of playing the game.
        To have a better appreciation of the graph click on smurfs to desactivate them.
        Based on the data we can guess that even if they are smurfs they could of followed the same rule.
    </p>
    </div>
