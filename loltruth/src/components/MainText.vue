...
<template>
    ...
    <p>DATA : all the data collected comes from 3 different servers : Korea, NA and EUW with an approximated total of 1000 players.I've purposely didnt show the smurfs on the graph below.</p>
    <p>The following graph show the first rank ever reached by the players wich means what is the rank they reached after only one season of playing
      as we can observe right there Diamond come first and platinum second but those two monopolyze a big part of the first rank.
    </p>
    </div>
</template>
